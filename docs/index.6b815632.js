...
const renderPixel = (pixel, context)=>{
    const [x, y, hue] = pixel;
    context.fillStyle = `hsl(${hue}, 50%, 40%)`;
    context.fillRect(x, y, 1, 1);
    context.fillRect(x, y, 1, 1);
};
const renderPixels = (data, context)=>{
...
const updatePixel = (pixel)=>{
    ...
    if (hue >= BOTTOM_HUE && hue <= TOP_HUE) return [
        pixel[0],
        pixel[1],
        hue,
        direction
...
},{}]},["4ibyE","kuM8f"], "kuM8f", "parcelRequire2e08")
